...
export const enTranslations: Translations = {
  ...
  header: {
    tagline: '— Real-Time World Expenditure Statistics',
    compareNav: 'Compare',
    homeNav: 'Home',
    timeframes: {
      year: 'Year 2026',
  ...
  searchAndFilter: {
    searchPlaceholder: 'Search statistics (e.g. equality ministry, raising child, pensions, food, wedding...)',
    showingCounters: (count: number) => `Showing: ${count} counters`,
    indicatorsCount: (count: number) => `${count} indicators`,
    noResultsFound: (q: string) => `No indicators match "${q}". Try another term.`,
  ...
  detailPage: {
    backLink: 'Back to all live statistics',
  ...
  footer: {
    methodologyTitle: 'STATISTICAL METHODOLOGY & DATA SOURCES',
    methodologyBody:
      'WorldSpend calculates macroeconomic, public expenditure, and industry flow metrics in continuous real time based on official baseline figures from the UN (UNODC/FAO), WHO, SIPRI, Eurostat, INE, Deloitte, UEFA, and institutional government registries.',
    copyrightTagline: 'WorldSpend.org — Global Real-Time Economic Statistics & Macro Financial Accounting',
    categoriesTitle: 'Expenditure Categories',
    trendingTitle: 'Popular & Trending Metrics',
    sourcesTitle: 'Official Data Institutions',
    toolsTitle: 'Platform & Webmaster Tools',
    disclaimerTitle: 'Disclaimer & Citation',
    disclaimerText:
      'Real-time spending rates are continuous approximations computed from audited annual benchmarks and official registries. Data is updated at 60 FPS for educational and journalistic visualization.',
    citationText: 'How to cite: WorldSpend Analytics. (2026). Global Real-Time Spend Indicators. Retrieved from https://worldspend.org',
  },
  categories: {
    all: {
