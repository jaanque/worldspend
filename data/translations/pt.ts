...
export const ptTranslations: Translations = {
  ...
  header: {
    tagline: '— Estatísticas Globais de Gastos em Tempo Real',
    compareNav: 'Comparar',
    homeNav: 'Início',
    timeframes: {
      year: 'Ano 2026',
  ...
  searchAndFilter: {
    searchPlaceholder: 'Pesquisar estatísticas (ex: ministério da igualdade, criar filho, aposentadorias, comida, casamento...)',
    showingCounters: (count: number) => `Mostrando: ${count} contadores`,
    indicatorsCount: (count: number) => `${count} indicadores`,
    noResultsFound: (query: string) => `Nenhum indicador estatístico encontrado para “${query}”.`,
  ...
  footer: {
    methodologyTitle: 'METODOLOGIA ESTATÍSTICA E FONTES OFICIAIS',
    methodologyBody:
      'WorldSpend calcula fluxos macroeconômicos e despesas governamentais em tempo real contínuo com base em dados oficiais da ONU (UNODC/FAO), OMS, SIPRI, Eurostat, INE, UEFA e orçamentos estatais.',
    copyrightTagline: 'WorldSpend.org — Estatísticas Globais e Contabilidade Financeira em Tempo Real',
    categoriesTitle: 'Categorias de Despesas',
    trendingTitle: 'Indicadores Populares',
    sourcesTitle: 'Instituições Oficiais de Dados',
    toolsTitle: 'Ferramentas e Recursos',
    disclaimerTitle: 'Aviso Legal e Citação',
    disclaimerText:
      'As taxas de gastos em tempo real são aproximações matemáticas contínuas calculadas a partir de dados anuais auditados. Atualização a 60 FPS para fins informativos e jornalísticos.',
    citationText: 'Como citar: WorldSpend Analytics. (2026). Indicadores Financeiros em Tempo Real. https://worldspend.org',
  },
  categories: {
